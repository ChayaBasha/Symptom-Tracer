...
// describe('Health Input API service', () => {
//     it('should request homepage', (done) =>{
...
//         })
//     })
//     it('should add a new Health Input Log', (done) => {
//         const testHealthInputLog = {
//             healthInputLogName: 'Food',
//             dateCreated: '2020-04-29T06:00:00Z',
//             user_id: '5ea634b1a4c1590ee2dcf9ef',
//         };
//         const expected = testHealthInputLog;

//         chai
//             .request('http://localhost:4000')
//             .post('/api/healthInputLog')
//             .end((err, res) => {
